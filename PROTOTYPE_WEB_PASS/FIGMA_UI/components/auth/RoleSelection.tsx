        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl text-gray-900">HAEMOLINK</span>
            </div>
          ...
          {roles.map((role) => {
            ...
            return (
              <button
                ...
                className="group relative bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-transparent hover:-translate-y-2 text-left"
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg md:text-xl text-gray-900 mb-2 md:mb-3">{role.title}</h3>
                  <p className="text-sm md:text-base text-gray-600 mb-6 md:mb-8">{role.description}</p>
