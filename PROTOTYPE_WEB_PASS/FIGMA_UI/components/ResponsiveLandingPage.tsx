...
export function ResponsiveLandingPage({ onGetStarted }: LandingPageProps) {
  ...
  const themes = {
    clean: {
      name: 'Clean Light',
      heroBg: 'bg-gradient-to-br from-white via-blue-50 to-blue-50',
      heroText: 'text-gray-900',
      heroSubtext: 'text-gray-600',
      headerText: 'text-gray-900',
      headerNav: 'text-gray-600 hover:text-gray-900',
      headerButton: 'bg-blue-600 text-white hover:bg-blue-700',
      impactBg: 'bg-gradient-to-br from-blue-50 via-violet-50 to-blue-50',
      impactText: 'text-gray-900',
      impactSubtext: 'text-gray-600',
      statCard: 'bg-white border-2 border-blue-100',
      statValue: 'text-blue-600',
      statLabel: 'text-gray-700',
    },
    healthcare: {
      name: 'Soft Healthcare',
      heroBg: 'bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50',
      heroText: 'text-slate-900',
      heroSubtext: 'text-slate-600',
      headerText: 'text-slate-900',
      headerNav: 'text-slate-600 hover:text-slate-900',
      headerButton: 'bg-blue-600 text-white hover:bg-blue-700',
      impactBg: 'bg-gradient-to-br from-green-50 via-blue-50 to-green-50',
      impactText: 'text-slate-900',
      impactSubtext: 'text-slate-600',
      statCard: 'bg-white/80 backdrop-blur border border-slate-200',
      statValue: 'text-green-600',
      statLabel: 'text-slate-700',
    },
    warm: {
      name: 'Warm Neutral',
      heroBg: 'bg-gradient-to-br from-stone-50 via-orange-50 to-stone-50',
      heroText: 'text-gray-900',
      heroSubtext: 'text-gray-600',
      headerText: 'text-gray-900',
      headerNav: 'text-gray-600 hover:text-gray-900',
      headerButton: 'bg-orange-600 text-white hover:bg-orange-700',
      impactBg: 'bg-gradient-to-br from-orange-50 via-violet-50 to-orange-50',
      impactText: 'text-gray-900',
      impactSubtext: 'text-gray-600',
      statCard: 'bg-white border border-orange-100',
